...
const plus_z = z(recurse => a => b => if_(is_zero(b))(() => a)(() => recurse(succ(a))(pred(b))));
const minus_z = z(recurse => a => b => if_(is_zero(b))(() => a)(() => recurse(pred(a))(pred(b))));
...
print_church(
  "if zero test: true",
  if_(is_zero(zero))(() => one)(() => zero)
);
print_church(
  "if zero test: false",
  if_(is_zero(one))(() => one)(() => zero)
);
print_church(
  "if zero test: false",
  if_(is_zero(succ(zero)))(() => one)(() => zero)
);
